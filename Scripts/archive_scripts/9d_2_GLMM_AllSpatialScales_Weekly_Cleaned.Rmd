...
- Tests VIF across covvariates included in models
...
mod_dat_wk <- read.csv("Processed_Data/glmm_2_wk_region_multi.csv", header=T)
...
Unscaled, with SPPSLM, the VIF's are all VERY high and the VIF for SPPSLM 4289
...
model1<- glm(Caribou ~ X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPG + X300_TSPS + X300_BAR, data=mod_dat_wk, family = "poisson")

vif(model1)

#model with SPPSLM 
model2<- glm(Caribou ~ X300_SPPSLM + X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPG + X300_TSPS + X300_BAR, data=mod_dat_wk, family = "poisson")
...
glmm_wk_lcc <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_TSPNF + X300_SPTNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + X300_TSPBDF + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_lcc_2 <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_lcc_tundra <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_WET + X300_WAT + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_comm_bu <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_comm_bu_tgt <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + target_hydro + target_linear + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk, family="nbinom2", control=glmmTMBControl(parallel=5))
...
#write.csv(summary_output, file = "Tables/region_2_multi_models_fnl.csv", row.names = FALSE)
```
...
mod_dat_wk_summer <- read.csv("Processed_Data/glmm_2_wk_region_smr.csv", header=T)
...
glmm_wk_smr_lcc <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_SPTNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + X300_TSPBDF + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_summer, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_smr_lcc_2 <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_summer, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_smr_lcc_tundra <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_WET + X300_WAT + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_summer, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_smr_comm_bu <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_summer, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_smr_comm_bu_tgt <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + target_linear + target_hydro + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_summer, family="nbinom2", control=glmmTMBControl(parallel=5))
...
mod_dat_wk_fall <- read.csv("Processed_Data/glmm_2_wk_region_fall.csv", header=T)
...
glmm_wk_fall_lcc <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_SPTNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + X300_TSPBDF + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_fall, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_fall_lcc_2 <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_fall, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_fall_lcc_tundra <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_WET + X300_WAT + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_fall, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_fll_comm_bu <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_fall, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_fll_comm_bu_tgt <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + target_hydro + target_linear + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_fall, family="nbinom2", control=glmmTMBControl(parallel=5))
...
```{r}
# Create a new data frame for winter
mod_dat_wk_winter <- read.csv("Processed_Data/glmm_2_wk_region_wtr.csv", header=T)
...
glmm_wk_wtr_lcc <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_SPTNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + X300_TSPBDF + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_winter, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_wtr_lcc_2 <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_winter, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_wtr_lcc_tundra <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_WET + X300_WAT + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_winter, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_wtr_comm_bu <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_winter, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_wtr_comm_bu_tgt <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + target_linear + target_hydro + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_winter, family="nbinom2", control=glmmTMBControl(parallel=5))
...
```{r}
# Create a new data frame for winter
mod_dat_wk_spri <- read.csv("Processed_Data/glmm_2_wk_region_spr.csv", header=T)
...
glmm_wk_spri_lcc <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_SPTNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + X300_TSPBDF + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_spri, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_spri_lcc_2 <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_spri, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_spri_lcc_tundra <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_WET + X300_WAT + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_spri, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_spr_comm_bu <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_spri, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_spr_comm_bu_tgt <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + target_hydro + target_linear + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_spri, family="nbinom2", control=glmmTMBControl(parallel=5))
...
```{r}
mod_dat_wk_cbou <- read.csv("Processed_Data/glmm_2_wk_local_multi.csv", header=T)
...
glmm_wk_cbou_lcc <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_SPTNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + X300_TSPBDF + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_lcc_2 <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_lcc_tundra <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_WET + X300_WAT + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_comm_bu <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_comm_bu_tgt <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + target_hydro + target_linear + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou, family="nbinom2", control=glmmTMBControl(parallel=5))
...
mod_dat_wk_cbou_summer <- read.csv("Processed_Data/glmm_2_wk_local_smr.csv", header=T)
...
glmm_wk_cbou_smr_lcc <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_SPTNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + X300_TSPBDF + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_summer, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_smr_lcc_2 <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_summer, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_smr_lcc_tundra <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_WET + X300_WAT + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_summer, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_smr_comm_bu <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_summer, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_smr_comm_bu_tgt <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + target_hydro + target_linear + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_summer, family="nbinom2", control=glmmTMBControl(parallel=5))
...
```{r}
# Create a new data frame for winter
mod_dat_wk_cbou_fall <- read.csv("Processed_Data/glmm_2_wk_local_fall.csv", header=T)
...
glmm_wk_cbou_fall_lcc <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_SPTNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + X300_TSPBDF + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_fall, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_fall_lcc_2 <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_fall, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_fall_lcc_tundra <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_WET + X300_WAT + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_fall, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_fll_comm_bu <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_fall, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_fll_comm_bu_tgt <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + target_hydro + target_linear + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_fall, family="nbinom2", control=glmmTMBControl(parallel=5))
...
```{r}
# Create a new data frame for winter
mod_dat_wk_cbou_winter <- read.csv("Processed_Data/glmm_2_wk_local_wtr.csv", header=T)
...
glmm_wk_cbou_wtr_lcc <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_SPTNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + X300_TSPBDF + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_winter, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_wtr_lcc_2 <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_winter, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_wtr_lcc_tundra <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_WET + X300_WAT + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_winter, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_wtr_comm_bu <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_winter, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_wtr_comm_bu_tgt <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + target_hydro + target_linear + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_winter, family="nbinom2", control=glmmTMBControl(parallel=5))
...
```{r}
# Create a new data frame for winter
mod_dat_wk_cbou_spri <- read.csv("Processed_Data/glmm_2_wk_local_spr.csv", header=T)
...
glmm_wk_cbou_spri_lcc <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_SPTNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + X300_TSPBDF + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_spri, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_spri_lcc_2 <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPS + X300_TSPG + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_spri, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_spri_lcc_tundra <- glmmTMB(Caribou ~ 
                    X300_SPPGLM + X300_SPPSLM + X300_WET + X300_WAT + X300_BAR + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_spri, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_spr_comm_bu <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_spri, family="nbinom2", control=glmmTMBControl(parallel=5))
...
glmm_wk_cbou_spr_comm_bu_tgt <- glmmTMB(Caribou ~ 
                  X300_SPPGLM + X300_TSPNF + X300_WET + X300_WAT + X300_MF + X300_TSPG + X300_BAR + z.mean_elev_300 + z.mean_tri_300 + z.esker_dist_m + target_hydro + target_linear + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_spri, family="nbinom2", control=glmmTMBControl(parallel=5))
