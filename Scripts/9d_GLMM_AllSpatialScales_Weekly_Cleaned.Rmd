...
#####NOTE: Removed TSPS due to very large standard errors. Removal resulted in normal values across remaining landcovers.
...
species_columns <- colnames(df)[7:76]  # Exclude the first two columns
