...
glmm_wk_ungpred <- glmmTMB(Caribou ~ 
                    Gray.Wolf + Grizzly.Bear + Muskox + Moose + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk, family="nbinom2", control=glmmTMBControl(parallel=5))
...
## Model Selection
```{r}
model.sel(glmm_wk_random_eff, glmm_wk_fourssn, glmm_wk_wk, glmm_wk_lcc_2, glmm_wk_dem, glmm_wk_tgt_h, glmm_wk_tgt_l, glmm_wk_ung, glmm_wk_ungpred, glmm_wk_comm_bu, glmm_wk_comm_td, glmm_wk_comm_app, glmm_wk_esker, glmm_wk_comm_bu_tgt, glmm_wk_comm_td_tgt, glmm_wk_comm_app_tgt)
```

###Save Model Selection
```{r}
# Capture the model selection
#summary_output <- capture.output(model.sel(glmm_wk_random_eff, glmm_wk_fourssn, glmm_wk_wk, glmm_wk_lcc_2, glmm_wk_dem, glmm_wk_tgt_h, glmm_wk_tgt_l, glmm_wk_ung, glmm_wk_ungpred, glmm_wk_comm_bu, glmm_wk_comm_td, glmm_wk_comm_app, glmm_wk_esker, glmm_wk_comm_bu_tgt, glmm_wk_comm_td_tgt, glmm_wk_comm_app_tgt))

# Save the model selection to a CSV file
#write.csv(summary_output, file = "Tables/region_multi_models.csv", row.names = FALSE)
```
...
### Ung + Predators
```{r}
glmm_wk_smr_ungpred <- glmmTMB(Caribou ~ 
                    Gray.Wolf + Grizzly.Bear + Muskox + Moose + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_summer, family="nbinom2", control=glmmTMBControl(parallel=5))


summary(glmm_wk_smr_ungpred)
```
...
## Model Selection
```{r}
model.sel(glmm_wk_smr_null, glmm_wk_smr_wk, glmm_wk_smr_lcc_2, glmm_wk_smr_dem, glmm_wk_smr_tgt_h, glmm_wk_smr_tgt_l, glmm_wk_smr_ung, glmm_wk_smr_ungpred, glmm_wk_smr_comm_bu, glmm_wk_smr_comm_td, glmm_wk_smr_comm_app, glmm_wk_smr_esker, glmm_wk_smr_comm_bu_tgt, glmm_wk_smr_comm_td_tgt, glmm_wk_smr_comm_app_tgt)
```

###Save Model Selection
```{r}
# Capture the model selection
#summary_output <- capture.output(model.sel(glmm_wk_smr_null, glmm_wk_smr_wk, glmm_wk_smr_lcc_2, glmm_wk_smr_dem, glmm_wk_smr_tgt_h, glmm_wk_smr_tgt_l, glmm_wk_smr_ung, glmm_wk_smr_ungpred, glmm_wk_smr_comm_bu, glmm_wk_smr_comm_td, glmm_wk_smr_comm_app, glmm_wk_smr_esker, glmm_wk_smr_comm_bu_tgt, glmm_wk_smr_comm_td_tgt, glmm_wk_smr_comm_app_tgt))

# Save the model selection to a CSV file
#write.csv(summary_output, file = "Tables/region_smr_models.csv", row.names = FALSE)
```
...
## Model Selection
```{r}
model.sel(glmm_wk_fall_null, glmm_wk_fall_wk, glmm_wk_fall_lcc_2, glmm_wk_fall_dem, glmm_wk_fall_tgt_h, glmm_wk_fall_tgt_l, glmm_wk_fall_ung, glmm_wk_fall_ungpred, glmm_wk_fll_comm_bu, glmm_wk_fll_comm_td, glmm_wk_fll_comm_app, glmm_wk_fll_comm_bu_tgt, glmm_wk_fll_comm_td_tgt, glmm_wk_fll_comm_app_tgt, glmm_wk_fall_esker)
```

###Save Model Selection
```{r}
# Capture the model selection
#summary_output <- capture.output(model.sel(glmm_wk_fall_null, glmm_wk_fall_wk, glmm_wk_fall_lcc_2, glmm_wk_fall_dem, glmm_wk_fall_tgt_h, glmm_wk_fall_tgt_l, glmm_wk_fall_ung, glmm_wk_fall_ungpred, glmm_wk_fll_comm_bu, glmm_wk_fll_comm_td, glmm_wk_fll_comm_app, glmm_wk_fll_comm_bu_tgt, glmm_wk_fll_comm_td_tgt, glmm_wk_fll_comm_app_tgt, glmm_wk_fall_esker))

# Save the model selection to a CSV file
#write.csv(summary_output, file = "Tables/region_fll_models.csv", row.names = FALSE)
```
...
## Model Selection
```{r}
model.sel(glmm_wk_wtr_null, glmm_wk_wtr_wk, glmm_wk_wtr_lcc_2, glmm_wk_wtr_dem, glmm_wk_wtr_tgt_l, glmm_wk_wtr_tgt_h, glmm_wk_wtr_ung, glmm_wk_wtr_ungpred, glmm_wk_wtr_comm_bu, glmm_wk_wtr_comm_td, glmm_wk_wtr_comm_app, glmm_wk_wtr_comm_bu_tgt, glmm_wk_wtr_comm_td_tgt, glmm_wk_wtr_comm_app_tgt, glmm_wk_wtr_esker)
```

###Save Model Selection
```{r}
# Capture the model selection
#summary_output <- capture.output(model.sel(glmm_wk_wtr_null, glmm_wk_wtr_lcc_2, glmm_wk_wtr_dem, glmm_wk_wtr_tgt_l, glmm_wk_wtr_tgt_h, glmm_wk_wtr_ung, glmm_wk_wtr_ungpred, glmm_wk_wtr_comm_bu, glmm_wk_wtr_comm_td, glmm_wk_wtr_comm_app, glmm_wk_wtr_comm_bu_tgt, glmm_wk_wtr_comm_td_tgt, glmm_wk_wtr_comm_app_tgt, glmm_wk_wtr_esker))

# Save the model selection to a CSV file
#write.csv(summary_output, file = "Tables/region_wtr_models.csv", row.names = FALSE)
```

###Save Top Model
```{r}
# Capture the summary output
#summary_output <- capture.output(summary(glmm_wk_wtr_lcc_2))

# Save the summary data to a CSV file
#write.csv(summary_output, file = "Tables/region_wtr_lcc_2.csv", row.names = FALSE)
```
...
## Model Selection
```{r}
model.sel(glmm_wk_spri_null, glmm_wk_spri_wk, glmm_wk_spri_lcc_2, glmm_wk_spri_dem, glmm_wk_spri_tgt_h, glmm_wk_spri_tgt_l, glmm_wk_spri_ung, glmm_wk_spri_ungpred, glmm_wk_spr_comm_bu, glmm_wk_spr_comm_td, glmm_wk_spr_comm_app, glmm_wk_spri_esker, glmm_wk_spr_comm_bu_tgt, glmm_wk_spr_comm_td_tgt, glmm_wk_spr_comm_app_tgt)
```

###Save Model Selection
```{r}
# Capture the model selection
#summary_output <- capture.output(model.sel(glmm_wk_spri_null, glmm_wk_spri_lcc_2, glmm_wk_spri_dem, glmm_wk_spri_tgt_h, glmm_wk_spri_tgt_l, glmm_wk_spri_ung, glmm_wk_spri_ungpred, glmm_wk_spr_comm_bu, glmm_wk_spr_comm_td, glmm_wk_spr_comm_app, glmm_wk_spri_esker, glmm_wk_spr_comm_bu_tgt, glmm_wk_spr_comm_td_tgt, glmm_wk_spr_comm_app_tgt))

# Save the model selection to a CSV file
#write.csv(summary_output, file = "Tables/region_spr_models.csv", row.names = FALSE)
```

###Save Top Model
```{r}
# Capture the summary output
#summary_output <- capture.output(summary(glmm_wk_spri_lcc_2))

# Save the summary data to a CSV file
#write.csv(summary_output, file = "Tables/region_spr_comm_lcc_2.csv", row.names = FALSE)
```
...
## Model Selection
```{r}
model.sel(glmm_wk_cbou_null, glmm_wk_cbou_fourssn, glmm_wk_cbou_wk, glmm_wk_cbou_lcc_2, glmm_wk_cbou_dem, glmm_wk_cbou_tgt_l, glmm_wk_cbou_tgt_h, glmm_wk_cbou_ung, glmm_wk_cbou_ungpred, glmm_wk_cbou_comm_bu, glmm_wk_cbou_comm_td, glmm_wk_cbou_comm_app, glmm_wk_cbou_esker, glmm_wk_cbou_comm_bu_tgt, glmm_wk_cbou_comm_td_tgt, glmm_wk_cbou_comm_app_tgt)
```

###Save Model Selection
```{r}
# Capture the model selection
#summary_output <- capture.output(model.sel(glmm_wk_cbou_null, glmm_wk_cbou_fourssn, glmm_wk_cbou_wk, glmm_wk_cbou_lcc_2, glmm_wk_cbou_dem, glmm_wk_cbou_tgt_l, glmm_wk_cbou_tgt_h, glmm_wk_cbou_ung, glmm_wk_cbou_ungpred, glmm_wk_cbou_comm_bu, glmm_wk_cbou_comm_td, glmm_wk_cbou_comm_app, glmm_wk_cbou_esker, glmm_wk_cbou_comm_bu_tgt, glmm_wk_cbou_comm_td_tgt, glmm_wk_cbou_comm_app_tgt))

# Save the model selection to a CSV file
#write.csv(summary_output, file = "Tables/local_multi_models.csv", row.names = FALSE)
```
...
## Model Selection
```{r}
model.sel(glmm_wk_cbou_smr_null, glmm_wk_cbou_smr_wk, glmm_wk_cbou_smr_lcc_2, glmm_wk_cbou_smr_dem, glmm_wk_cbou_smr_tgt_h, glmm_wk_cbou_smr_tgt_l, glmm_wk_cbou_smr_ung, glmm_wk_cbou_smr_ungpred, glmm_wk_cbou_smr_comm_bu, glmm_wk_cbou_smr_comm_td, glmm_wk_cbou_smr_comm_app, glmm_wk_cbou_smr_comm_bu_tgt, glmm_wk_cbou_smr_comm_td_tgt, glmm_wk_cbou_smr_comm_app_tgt, glmm_wk_cbou_smr_esker)
```

###Save Model Selection
```{r}
# Capture the model selection
#summary_output <- capture.output(model.sel(glmm_wk_cbou_smr_null, glmm_wk_cbou_smr_lcc_2, glmm_wk_cbou_smr_dem, glmm_wk_cbou_smr_tgt_h, glmm_wk_cbou_smr_tgt_l, glmm_wk_cbou_smr_ung, glmm_wk_cbou_smr_ungpred, glmm_wk_cbou_smr_comm_bu, glmm_wk_cbou_smr_comm_td, glmm_wk_cbou_smr_comm_app, glmm_wk_cbou_smr_comm_bu_tgt, glmm_wk_cbou_smr_comm_td_tgt, glmm_wk_cbou_smr_comm_app_tgt, glmm_wk_cbou_smr_esker))

# Save the model selection to a CSV file
#write.csv(summary_output, file = "Tables/local_smr_models.csv", row.names = FALSE)
```
...
glmm_wk_cbou_fall_ungpred <- glmmTMB(Caribou ~ 
                    Muskox + Moose + Gray.Wolf + Grizzly.Bear + offset(log(n_days_effort)) + (1|location_site) , data=mod_dat_wk_cbou_fall, family="nbinom2", control=glmmTMBControl(parallel=5))
...
## Model Selection
```{r}
model.sel(glmm_wk_cbou_fall_null, glmm_wk_cbou_fall_wk, glmm_wk_cbou_fall_lcc_2, glmm_wk_cbou_fall_dem, glmm_wk_cbou_fall_tgt_h, glmm_wk_cbou_fall_tgt_l, glmm_wk_cbou_fall_ung, glmm_wk_cbou_fall_ungpred, glmm_wk_cbou_fll_comm_bu, glmm_wk_cbou_fll_comm_td, glmm_wk_cbou_fll_comm_app, glmm_wk_cbou_fall_esker, glmm_wk_cbou_fll_comm_bu_tgt, glmm_wk_cbou_fll_comm_td_tgt, glmm_wk_cbou_fll_comm_app_tgt)
```

###Save Model Selection
```{r}
# Capture the model selection
#summary_output <- capture.output(model.sel(glmm_wk_cbou_fall_null, glmm_wk_cbou_fall_lcc_2, glmm_wk_cbou_fall_dem, glmm_wk_cbou_fall_tgt_h, glmm_wk_cbou_fall_tgt_l, glmm_wk_cbou_fall_ung, glmm_wk_cbou_fall_ungpred, glmm_wk_cbou_fll_comm_bu, glmm_wk_cbou_fll_comm_td, glmm_wk_cbou_fll_comm_app, glmm_wk_cbou_fall_esker, glmm_wk_cbou_fll_comm_bu_tgt, glmm_wk_cbou_fll_comm_td_tgt, glmm_wk_cbou_fll_comm_app_tgt))

# Save the model selection to a CSV file
#write.csv(summary_output, file = "Tables/local_fll_models.csv", row.names = FALSE)
```
...
## Model Selection
```{r}
model.sel(glmm_wk_cbou_wtr_null, glmm_wk_cbou_wtr_lcc_2, glmm_wk_cbou_wtr_dem, glmm_wk_cbou_wtr_tgt_h, glmm_wk_cbou_wtr_tgt_l, glmm_wk_cbou_wtr_ung, glmm_wk_cbou_wtr_ungpred, glmm_wk_cbou_wtr_comm_bu, glmm_wk_cbou_wtr_comm_td, glmm_wk_cbou_wtr_comm_app, glmm_wk_cbou_wtr_comm_bu_tgt, glmm_wk_cbou_wtr_comm_td_tgt, glmm_wk_cbou_wtr_comm_app_tgt, glmm_wk_cbou_wtr_esker)
```

###Save Model Selection
```{r}
# Capture the model selection
#summary_output <- capture.output(model.sel(glmm_wk_cbou_wtr_null, glmm_wk_cbou_wtr_lcc_2, glmm_wk_cbou_wtr_dem, glmm_wk_cbou_wtr_tgt_h, glmm_wk_cbou_wtr_tgt_l, glmm_wk_cbou_wtr_ung, glmm_wk_cbou_wtr_ungpred, glmm_wk_cbou_wtr_comm_bu, glmm_wk_cbou_wtr_comm_td, glmm_wk_cbou_wtr_comm_app, glmm_wk_cbou_wtr_comm_bu_tgt, glmm_wk_cbou_wtr_comm_td_tgt, glmm_wk_cbou_wtr_comm_app_tgt, glmm_wk_cbou_wtr_esker))

# Save the model selection to a CSV file
#write.csv(summary_output, file = "Tables/local_wtr_models.csv", row.names = FALSE)
```
...
# Save the summary data to a CSV file
#write.csv(summary_output, file = "Tables/local_wtr_comm_td.csv", row.names = FALSE)
```
...
## Model Selection
```{r}
model.sel(glmm_wk_cbou_spri_null, glmm_wk_cbou_spri_lcc_2, glmm_wk_cbou_spri_dem, glmm_wk_cbou_spri_tgt_h, glmm_wk_cbou_spri_tgt_l, glmm_wk_cbou_spri_ung, glmm_wk_cbou_spri_ungpred, glmm_wk_cbou_spr_comm_bu, glmm_wk_cbou_spr_comm_td, glmm_wk_cbou_spr_comm_app, glmm_wk_cbou_spr_comm_bu_tgt, glmm_wk_cbou_spr_comm_td_tgt, glmm_wk_cbou_spr_comm_app_tgt, glmm_wk_cbou_spri_esker)
```

###Save Model Selection
```{r}
# Capture the model selection
#summary_output <- capture.output(model.sel(glmm_wk_cbou_spri_null, glmm_wk_cbou_spri_lcc_2, glmm_wk_cbou_spri_dem, glmm_wk_cbou_spri_tgt_h, glmm_wk_cbou_spri_tgt_l, glmm_wk_cbou_spri_ung, glmm_wk_cbou_spri_ungpred, glmm_wk_cbou_spr_comm_bu, glmm_wk_cbou_spr_comm_td, glmm_wk_cbou_spr_comm_app, glmm_wk_cbou_spr_comm_bu_tgt, glmm_wk_cbou_spr_comm_td_tgt, glmm_wk_cbou_spr_comm_app_tgt, glmm_wk_cbou_spri_esker))

# Save the model selection to a CSV file
#write.csv(summary_output, file = "Tables/local_spr_models.csv", row.names = FALSE)
```
